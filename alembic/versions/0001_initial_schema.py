...
def upgrade() -> None:
    workspace_role = postgresql.ENUM("owner", "admin", "member", name="workspace_role")
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_workspace_members_workspace_id_workspaces", ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"],
            name="fk_workspace_members_user_id_users", ondelete="CASCADE",
        ),
